  ...
  <div class="w-full px-6 py-6 mx-auto">
    ...
    <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
      ...
      <div slide class="absolute w-full h-full transition-all duration-500">
        ...
        <p class="dark:opacity-80">There’s nothing I really wanted to do in life that I wasn’t able to get good at.
        </p>
        </div>
      </div>
      ...
      <div slide class="absolute w-full h-full transition-all duration-500">
        ...
        <p class="dark:opacity-80">That’s my skill. I’m not really specifically talented at anything except for the
          ability to learn.</p>
        </div>
      </div>
      ...
      <div slide class="absolute w-full h-full transition-all duration-500">
        ...
        <p class="dark:opacity-80">Don’t be afraid to be wrong because you can’t learn anything from a compliment.
        </p>
        </div>
      </div>
      ...
      <div class="flex-auto p-4">
        ...
        <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-t-lg rounded-xl text-inherit">
          ...
          <div class="flex flex-col">
            ...
            <span class="text-xs leading-tight dark:text-white/80">250 in stock, <span class="font-semibold">346+
              sold</span></span>
          </div>
          </div>
          <div class="flex">
